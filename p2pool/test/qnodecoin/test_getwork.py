...
from p2pool.qnodecoin import getwork, data as qnodecoin_data
    ...
    def test_all(self):
        ...
        case2s = [
            getwork.BlockAttempt(
                ...
                1305759879,
                qnodecoin_data.FloatingInteger.from_target_upper_bound(0x44b9f20000000000000000000000000000000000000000000000),
